...
function SubmitForm(){
	if(InvalidKeyWord()){
		alert('Keyword should have atleast 3 characters');
		return;
	}
...
function InvalidKeyWord() {
	var myInput = document.getElementById('field_keyword');
	if(myInput && myInput.value && myInput.value.length > 0 && myInput.value.length < 3){
		return true;
	}
	return false;	
}
...
<form id=search_form action='{$ibforums->base_url}act=Ematch&CODE=11' method='POST' >
...
<th align=center>
	<table bgcolor="ffffcc">
		...
		<p>If no fitful field is found, input your keyword here: (minimum 3 characters)
		<p><input type=text id=field_keyword name=field_keyword value="">
		<tr>
		...
		<tr>
			...
			<br>
			<input type="button" value="Go Search!" onclick="SubmitForm();"> 
		<tr>
...
<tr>	
	...
	<td> <A href="http://newfirebird.cs.txstate.edu/~m_g859/cs5334-php/index.php?act=Ematch&CODE=10">Job Search </a>
	<td> <A href="http://newfirebird.cs.txstate.edu/~m_g859/cs5334-php/index.php?act=Ematch&CODE=20">Employers </A>
	<td> <A href="http://newfirebird.cs.txstate.edu/~m_g859/cs5334-php/index.php?act=Ematch&CODE=30">Members </A>
</tr>
</table>
	</center>
</body>
...
<tr>
	...
	<tr>
		<td>
		<a href="/~m_g859/demo/proc/unix-version/html/employers_search.html">
		Search for a professional candidate
		</a>
	<tr>
		<td>
		<a href="/~m_g859/demo/proc/unix-version/html/employers_newgraduatesearch.html">
		Search for a new graduate candidate
		</a>
	<tr>
		<td>
		<a href="/~m_g859/demo/proc/unix-version/html/submit_new_job.html">
		Submit a new job
		</a>
	<tr>
		<td>
...
<TABLE CELLSPACING="0" CELLPADDING="3" BORDER="0">
<tr>    
	<td> <a href="/~m_g859/cs5334-php/index.php?act=Ematch&CODE=00">Home </a>
	<td> <a href="/~m_g859/cs5334-php/index.php?act=Ematch&CODE=10">Job Search </a>
	<td> <a href="/~m_g859/cs5334-php/index.php?act=Ematch&CODE=20"> Employers </a>
	<td> <a href="/~m_g859/cs5334-php/index.php?act=Ematch&CODE=30">Members </a>
</tr>
</table>
	</center>
...
<tr>
	<td> <input type=button value="Home" onClick="location='http://newfirebird.cs.txstate.edu/~m_g859/cs5334-php/index.php?act=Ematch&CODE=00'"></td>
	<td> <input type=button value="Job Search" onClick="location='http://newfirebird.cs.txstate.edu/~m_g859/cs5334-php/index.php?act=Ematch&CODE=10'"></td>
	<td> <input type=button value="Employers" onClick="location='http://newfirebird.cs.txstate.edu/~m_g859/cs5334-php/index.php?act=Ematch&CODE=20'"></td>
	<td> <input type=button value="Members" onClick="location='http://newfirebird.cs.txstate.edu/~m_g859/cs5334-php/index.php?act=Ematch&CODE=30'"></td>
</tr>
</table>
</td>
</tr>
